...
---
format:
  html: {toc: true, toc-depth: 4, theme: cosmo, output-file: notebooks.index.html}
fontsize: 0.9em
...
<script src="notebooks.index_files/md-default0.js" type="text/javascript"></script><script src="notebooks.index_files/md-default1.js" type="text/javascript"></script>
...
```{=html}
<div><pre><small><small>source: src/notebooks/index.clj</small></small></pre></div>
```
